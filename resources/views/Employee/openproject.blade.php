        ...
        <div class="wizard-v1-content">
            <div class="wizard-form">
                <table class="table table-striped">
                    ...
                    <tbody>
                    <tr>
                        @if($pr['textilesMinistryFileStatus'] == 'pending')
                        ...
                        <td> <a href="/updateTextilesMinistryFileStatus/{{$pr['id']}}" class="btn btn--green">Confirm</a></td>
                        @endif
                    </tr>
                    <tr>
                        @if($pr['environmentMinistryFileStatus'] == 'pending')
                        ...
                        <td> <a href="/updateEnvironmentMinistryFileStatus/{{$pr['id']}}" class="btn btn--green">Confirm</a></td>
                        @endif
                    </tr>
                    <tr>
                        @if($pr['foreignMinistryFileStatus'] == 'pending')
                        <td>Ministry of Foreign Affairs</td>
                        <td> <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ffileView"> VIEW </button> </td>
                        <td> <a href="/updateforeignMinistryFileStatus/{{$pr['id']}}" class="btn btn--green">Confirm</a></td>
                        @endif
                    </tr>
                    <tr>
                        @if($pr['planningMinistryFileStatus'] == 'pending')
                        ...
                        <td> <a href="/updateplanningMinistryFileStatus/{{$pr['id']}}" class="btn btn--green">Confirm</a></td>
                        @endif
                    </tr>
